package com.yifasilverguard.constant;
...
public class LoginConstant {
    ...
    public static final String BIND_PHONE_SUCCESS = "手机号绑定成功";
    public static final String BIND_PHONE_ERROR = "手机号已被绑定/验证码错误/手机号格式错误";
    public static final String SMS_CODE_SENT = "短信验证码已发送";
}